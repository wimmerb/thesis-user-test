...
//        this.TestState.Runtime.forEach(function(element, index, array){array[index] = 0});
    ...
    ListeningTest.prototype.runTest = function(TestIdx) {
        ...
        $('#TestAdvise').html(this.TestConfig.Testsets[TestIdx].Advise);
        $('#TestAdvise').show();
...
MushraTest.prototype.createTestDOM = function (TestIdx) {
        ...
        if (this.TestState.FileMappings[TestIdx].includes("Reference"))
        {
            ...
            cell[1].innerHTML =  '<button id="play'+fileID+'Btn" class="playButton" rel="'+fileID+'" style="width:100px;">Play</button>';
            cell[2] = row.insertCell(-1);
            cell[2].innerHTML = "<button class='stopButton' style='width:100px;'>Stop</button>";  
            $('#TestReference').html(tab);
            $('#TestReference').show();
        ...
        console.log (this.TestState.FileMappings)
        ...
        if (this.TestState.FileMappings[TestIdx].includes("Reference"))
        {
            ...
            // cell[3] = row.insertCell(-1);
            cell[3].innerHTML = "<img id='ScaleImage' src='"+this.TestConfig.RateScalePngRef+"'/>";  	
